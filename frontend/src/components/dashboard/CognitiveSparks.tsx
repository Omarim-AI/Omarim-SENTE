...
interface CognitiveSparksProps {
  count?: number;
  color?: THREE.Color;
}

const CognitiveSparks: React.FC<CognitiveSparksProps> = ({ count = 200, color = new THREE.Color('#ffab00') }) => {
...
export default CognitiveSparks;
